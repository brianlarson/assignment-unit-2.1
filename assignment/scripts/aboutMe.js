...
let introduction = `My name is ${fullName}, and I think ${luckyNumber} is the winner!`;
...
let food = `LeeAnn Chin cream cheese wontons 🤤`;
console.log(food);
...
if (pets > friendsPets) {
    ...
    mostPets = `I have the same number of pets as my friend!`;
}
...
switch (luckyNumber) {
    ...
    case 2:
        ...
        break;
    case 3:
        luckyResult = `Third is the one in the polka dot dress`;
        break;
    default:
...
let newResult = adventurous ? `Adventures are great!` : `How about we stay home?`;
